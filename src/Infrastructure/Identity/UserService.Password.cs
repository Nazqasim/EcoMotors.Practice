...
using EcoMotorsPractice.Application.Identity;
...
internal partial class UserService
{
    ...
    public async Task<bool> VerifyOtpTokenAsync(VerifyOtpTokenRequest request)
    {
        var user = await _userManager.FindByEmailAsync(request.Email?.Normalize());
        ...
        bool isValid = await _userManager.VerifyUserTokenAsync(user, TokenOptions.DefaultPhoneProvider, "ResetPassword", request.Token);
