...
using EcoMotorsPractice.Shared.Notifications;
using Microsoft.AspNetCore.SignalR;
using static EcoMotorsPractice.Shared.Notifications.NotificationConstants;

namespace EcoMotorsPractice.Infrastructure.Notifications;
